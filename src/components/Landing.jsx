...
const Landing = () => {
  // State to toggle the paragraph expansion
  const [isExpanded, setIsExpanded] = useState(false);

  // Function to toggle the paragraph state
      ...
      <div className="w-full h-[88vh] flex xsm:flex-col-reverse md:flex-row">
        <div id="left" className='md:w-[55%] md:h-full xsm:w-full xsm:h-[55%] flex flex-col xsm:flex-col-reverse items-end justify-center'>
          <div className='md:w-[60%] xsm:w-full md-px-0 xsm:px-4 xsm:pl-7 md-pl-0'>
            <div className='md:mr-[8vw] mb-[4vh] md:w-[50%] w-[60%] md:text-[0.9em] xsm:text-[0.8em] md:px-2 md:py-3 xsm:py-1 xsm:px-3 rounded-md text-center bg-blue-600 text-white'>
              <h3 className='whitespace-none'>Water is Nothing But Life</h3>
            </div>
            ...
            {/* Conditionally render paragraph based on the state */}
            <p className='mr-[8vw] mb-[4vh] md:text-[0.7em] xsm:text-[0.6em]'>
              {isExpanded
                ? "Experience the purity and refreshing taste of Ishani Aqua Mineral Water. Our water is sourced from pristine springs and undergoes rigorous filtration to ensure it meets the highest standards of quality. Whether it's for your daily hydration or special occasions, trust Ishani Aqua Mineral Water to deliver the freshness and mineral-rich goodness your body deserves."
                : "Experience the purity and refreshing taste of Ishani Aqua Mineral Water. Our water is sourced from pristine springs and undergoes rigorous filtration..."}
            </p>

            {/* Button to toggle the state */}
            <Button text={isExpanded ? "Less" : "Read more"} func={toggleParagraph} />
          </div>
        </div>
      ...
      <div className="w-full min-h-[100vh] md:py-6">
        ...
        <div className="mt-10 grid grid-cols-1">
          ...
          <DetCard 
            ...
            text="Trusted by 200+ customers since our launch" 
          />
          <DetCard 
